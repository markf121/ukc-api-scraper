...
module.exports = function (logger, GradeUtils) {
  ...
  function increaseDifficultyGroupTotalByType (groupPos, typeId, types) {
  ...
  function increaseTotalClimbsByType (typeId, types) {
    var type = camelCase(GradeUtils.climbTypes[typeId]);
    if (!types[type]) {
      types[type] = 0;
    }
  ...
  function increaseDifficultyGroupTotals (groupPos, totals) {
          ...
          self.models.Grade.findOne(
            {
              ...
              if (!grade) {
                ...
                if (grade.difficultyGroup !== null) {
                  increaseDifficultyGroupTotals(grade.difficultyGroup, self.data.difficultyGroupTotals);
                ...
                increaseTotalClimbsByType(data.climbType, self.data.totalClimbsByType);
              }
