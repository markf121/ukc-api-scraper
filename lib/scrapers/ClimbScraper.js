...
module.exports = function (Scraper, ClimbRequester, logger) {
  ...
  ClimbScraper.getClimbTypeId = function (type) {
    var id = ClimbScraper.climbTypes.indexOf(type);
    if (id >= 0) {
      id = id + 1;
    } else {
      id = null;
  ...
  ClimbScraper.parseRawGrade = function (rawGrade) {
    ...
    if (matches) {
      ...
      grade.type = 'Scottish';
      grade.climbType = ClimbScraper.getClimbTypeId('Winter');
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'British';
      grade.climbType = ClimbScraper.getClimbTypeId('Trad');
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Font';
      grade.climbType = ClimbScraper.getClimbTypeId('Bouldering');
    ...
    if (matches) {
      ...
      if (grade.grade.match(/^F/)) {
        ...
        grade.climbType = ClimbScraper.getClimbTypeId('Sport');
      }
      return grade;
    }
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Ice';
      grade.climbType = ClimbScraper.getClimbTypeId('Ice');
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Mixed';
      grade.climbType = ClimbScraper.getClimbTypeId('Mixed');
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Alpine';
      grade.climbType = ClimbScraper.getClimbTypeId('Alpine');
    ...
    if (matches) {
      ...
      grade.climbType = ClimbScraper.getClimbTypeId('Via Ferrata');
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Aid';
      grade.climbType = ClimbScraper.getClimbTypeId('Aid');
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Scramble';
      grade.climbType = ClimbScraper.getClimbTypeId('Scrambling');
      return grade;
    }
    ...
    if (matches) {
      grade.grade = matches[1];
      grade.type = 'Special';
      grade.climbType = ClimbScraper.getClimbTypeId('Special');
      return grade;
    }
