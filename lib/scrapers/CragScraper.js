...
module.exports = function (Scraper, ClimbScraper, CragRequester) {
  ...
  CragScraper.prototype._addReferenceToModerator = function () {
    var self = this;
    var promise = Vow.promise();
    var data = this.cragData.moderator;

    if (!this.cragData.moderator) {
      promise.fulfill();
    } else {
      var id = data.id;
      delete data.id;
