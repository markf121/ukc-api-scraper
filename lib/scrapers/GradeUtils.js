module.exports = function () {
  ...
  GradeUtils.parseRawGrade = function (rawGrade, countryId) {
    var grade = {
      ukTechGrade: null,
      stars: 0
    };
    ...
    var ukAdjRegex = /^(M|D|HD|VD|HVD|MS|S|HS|MVS|VS|HVS|E[\d]{1,2}|none|XS)\b/;
    ...
    var fontRegex = /^(font [2|3|4|5]\+?|f[6|7|8|9][A|B|C]\+?)/;
    ...
    var frenchRegex = /^(F?[2|3|4|5]\+?|F?[6|7|8|9][a|b|c]\+?|Project)/;
